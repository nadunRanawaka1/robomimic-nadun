...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--agent",
        type=str,
        default="/media/nadun/Data/phd_project/robomimic/bc_trained_models/diffusion_policy/lift_image_diffusion_policy/20240609000333/models/model_epoch_600.pth",
        required=False,
    ...
    if args.rollout_stats_path is None:
        args.rollout_stats_path = os.path.abspath(os.path.join(os.path.dirname(args.agent), '..', 'logs', 'multi_eval_stats_scale_fix.xlsx'))
