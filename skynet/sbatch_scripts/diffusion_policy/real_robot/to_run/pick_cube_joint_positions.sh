#!/bin/bash
#SBATCH --job-name=joint_control_pick_cube_wrist_cam
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/real_robot/pick_cube/joint_control_pick_cube_wrist_cam.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/real_robot/pick_cube/joint_control_pick_cube_wrist_cam.err
