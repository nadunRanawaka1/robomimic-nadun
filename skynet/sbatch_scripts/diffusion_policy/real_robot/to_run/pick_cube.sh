#!/bin/bash
#SBATCH --job-name=robomimic_pick_cube_act_seq_50
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/real_robot/robomimic_pick_cube_act_seq_50.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/real_robot/robomimic_pick_cube_act_seq_50.err
